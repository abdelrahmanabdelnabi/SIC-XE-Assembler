...
import sicXE.assembler.datastructures.OpcodeTable;
...
public class ObjectBuilderTesting {
    ...
    private final String format2_FilePath = relativePath + "/sicXE/testIn/format2.asm";
    private final String format3_FilePath = relativePath + "/sicXE/testIn/format3.asm";
    private final String format4_FilePath = relativePath + "/sicXE/testIn/format4.asm";

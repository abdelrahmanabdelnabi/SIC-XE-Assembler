...
public class ObjectBuilderTesting {
    ...
    private String format1_FilePath = relativePath + "/src/tests/format1.asm";
    private String format2_FilePath = relativePath + "/src/tests/format2.asm";
    private String format3_FilePath = relativePath + "/src/tests/format3.asm";
    private String format4_FilePath = relativePath + "/src/tests/format4.asm";

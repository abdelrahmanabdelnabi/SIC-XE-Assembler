...
public class OpcodeTable {
    ...
    private static void fillOpcodeTable() {
        ...
        opCodeTable.put("ADD", new InstProp(24, Format.FORMAT3));
        opCodeTable.put("ADDF", new InstProp(88, Format.FORMAT3));
        opCodeTable.put("ADDR", new InstProp(144, Format.FORMAT2));
        opCodeTable.put("AND", new InstProp(64, Format.FORMAT3));
        opCodeTable.put("CLEAR", new InstProp(180, Format.FORMAT2));
        opCodeTable.put("COMP", new InstProp(40, Format.FORMAT3));
        opCodeTable.put("COMPF", new InstProp(136, Format.FORMAT3));
        opCodeTable.put("COMPR", new InstProp(160, Format.FORMAT2));
        opCodeTable.put("DIV", new InstProp(36, Format.FORMAT3));
        opCodeTable.put("DIVF", new InstProp(100, Format.FORMAT3));
        ...
        opCodeTable.put("J", new InstProp(60, Format.FORMAT3));
        opCodeTable.put("JEQ", new InstProp(48, Format.FORMAT3));
        opCodeTable.put("JGT", new InstProp(52, Format.FORMAT3));
        opCodeTable.put("JLT", new InstProp(56, Format.FORMAT3));
        opCodeTable.put("JSUB", new InstProp(72, Format.FORMAT3));
        opCodeTable.put("LDA", new InstProp(0, Format.FORMAT3));
        opCodeTable.put("LDB", new InstProp(104, Format.FORMAT3));
        opCodeTable.put("LDCH", new InstProp(80, Format.FORMAT3));
        opCodeTable.put("LDF", new InstProp(112, Format.FORMAT3));
        opCodeTable.put("LDL", new InstProp(8, Format.FORMAT3));
        opCodeTable.put("LDS", new InstProp(108, Format.FORMAT3));
        opCodeTable.put("LDT", new InstProp(116, Format.FORMAT3));
        opCodeTable.put("LDX", new InstProp(4, Format.FORMAT3));
        opCodeTable.put("LPS", new InstProp(208, Format.FORMAT3));
        opCodeTable.put("MUL", new InstProp(32, Format.FORMAT3));
        opCodeTable.put("MULF", new InstProp(96, Format.FORMAT3));
        opCodeTable.put("MULR", new InstProp(152, Format.FORMAT2));
        opCodeTable.put("NORM", new InstProp(200, Format.FORMAT1));
        opCodeTable.put("OR", new InstProp(68, Format.FORMAT3));
        opCodeTable.put("RD", new InstProp(216, Format.FORMAT3));
        opCodeTable.put("RMO", new InstProp(172, Format.FORMAT2));
        opCodeTable.put("RSUB", new InstProp(76, Format.FORMAT3));
        ...
        opCodeTable.put("TD", new InstProp(224, Format.FORMAT3));
        opCodeTable.put("TIO", new InstProp(248, Format.FORMAT1));
        opCodeTable.put("TIX", new InstProp(44, Format.FORMAT3));
        opCodeTable.put("TIXR", new InstProp(184, Format.FORMAT2));
        opCodeTable.put("WD", new InstProp(220, Format.FORMAT3));
        opCodeTable.put("SSK", new InstProp(236, Format.FORMAT3));
        opCodeTable.put("STA", new InstProp(12, Format.FORMAT3));
        opCodeTable.put("STB", new InstProp(120, Format.FORMAT3));
        opCodeTable.put("STCH", new InstProp(84, Format.FORMAT3));
        opCodeTable.put("STF", new InstProp(128, Format.FORMAT3));
        opCodeTable.put("STI", new InstProp(212, Format.FORMAT3));
        opCodeTable.put("STL", new InstProp(20, Format.FORMAT3));
        opCodeTable.put("STS", new InstProp(124, Format.FORMAT3));
        opCodeTable.put("STSW", new InstProp(232, Format.FORMAT3));
        opCodeTable.put("STT", new InstProp(132, Format.FORMAT3));
